...
public class SmppLoadBalancer implements Serializable {
	...
	private transient SmppLoadBalancerHeartBeatingService loadBalancerHeartBeatingService;
	private transient boolean available;
	private transient boolean displayWarning;
	private transient Properties customInfo;

	public SmppLoadBalancer(SmppLoadBalancerHeartBeatingService loadBalancerHeartBeatingService, InetAddress address,
			int rmiPort) {
	...
	public static SmppLoadBalancer getInstanceWithoutRMI(
			SmppLoadBalancerHeartBeatingService loadBalancerHeartBeatingService, InetAddress address,
			SipProvider sipProvider) {
		return new SmppLoadBalancer(loadBalancerHeartBeatingService, address, -1);
	}
	...
	public boolean equals(Object obj) {
		...
		if (super.getClass() != obj.getClass())
			return false;
		SmppLoadBalancer other = (SmppLoadBalancer) obj;
